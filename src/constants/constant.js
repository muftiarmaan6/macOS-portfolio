  ...
  children: [
    {
      ...
      kind: "folder",
      description: [
        "A decentralized expense-splitting dApp built on the Stellar blockchain.",
        "Connect your Freighter wallet, create groups, add expenses, and settle up — all on-chain.",
      ],
      href: "https://split-pay-nine.vercel.app",
      github: "https://github.com/muftiarmaan6/Split-Pay",
      children: [],
    },
  ],
};
